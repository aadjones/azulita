      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-2 text-neutral-light">
              ...
              <p>
                ...
                >
                  ...
                  {content.footer.contact.instagram}
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-end md:text-right">
            <p className="text-2xl font-semibold mb-2">Azulita Holistics</p>
            <p className="text-neutral-light text-sm">
              {language === 'en' ? 'Natural healing & wellness' : 'Sanación natural y bienestar'}
            </p>
          </div>
        </div>
